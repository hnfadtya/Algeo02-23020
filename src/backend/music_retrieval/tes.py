import os
from MIR import process_midi, extract_features, cosine_similarity, proses_database, query_by_humming, print_top_similar_song
import numpy as np
from midi_json import save_json, load_json
from convert_to_midi import wav_to_midi

# Lokasi file MIDI
TEST_MIDI_PATH = "C:/coding/Tingkat 2/Tubes Algeo 2/Algeo02-23020/src/backend/music_retrieval/database/Remember_the_Time.mid"  # Ubah sesuai lokasi file MIDI Anda
DATABASE_FOLDER = "C:/coding/Tingkat 2/Tubes Algeo 2/Algeo02-23020/src/backend/music_retrieval/database/midi"  # Ubah ke direktori database Anda
TEST_WAV_PATH = "C:/coding/Tingkat 2/Tubes Algeo 2/Algeo02-23020/src/backend/music_retrieval/database/wav/blues.00001.wav"
...
#fungsi main
# hasil_convert= wav_to_midi(TEST_WAV_PATH)
# vek = process_midi (hasil_convert)
# print (vek)
